  ...
  return (
    <div class={styleWrapper}>
      <ButtonRow label='Counter Bass'>
        <For each={COUNTER_BASS_ROW_NOTES}>
          {(midiNote) => {
            return <Button midiNote={midiNote} />
          }}
        </For>
      </ButtonRow>
      <ButtonRow label='Bass'>
        <For each={BASS_ROW_NOTES}>
          {(midiNote) => {
            return <Button midiNote={midiNote} />
          }}
        </For>
      ...
      <ButtonRow label='Major'>
        <For each={MAJOR_CHORD_ROW_NOTES}>
          {(midiNotes) => {
            return <Button midiNotes={midiNotes} />
          }}
        </For>
      </ButtonRow>
      <ButtonRow label='Minor'>
        <For each={MINOR_CHORD_ROW_NOTES}>
          {(midiNotes) => {
            return <Button midiNotes={midiNotes} />
          }}
        </For>
      ...
      <ButtonRow label='Seventh'>
        <For each={SEVENTH_CHORD_ROW_NOTES}>
          {(midiNotes) => {
            return <Button midiNotes={midiNotes} />
          }}
        </For>
      ...
      <ButtonRow label='Diminished'>
        <For each={DIMINSHED_CHORD_ROW_NOTES}>
          {(midiNotes) => {
            return <Button midiNotes={midiNotes} />
          }}
        </For>
